	...
	<div class="conteudo">
		<form action="AdicionarMotorista" style="width: 90%" method="post">
			...
			<div class="caixa-padrao" style="margin-left: 0px">
				<label>CPF</label><br>
				<s:textfield disabled="true" name="motorista.cpf" />
				<br>
			</div>
			...
			<div class="caixa-padrao" style="width: 21%">
				...
				<s:textfield type="date" disabled="true"
					name="motorista.dataDeNascimento" />
				<br>
			</div>
			...
			<div class="caixa-padrao" style="width: 21%">
				...
				<s:textfield disabled="true" name="motorista.bairro" />
				<br>
			</div>
			<div class="caixa-padrao" style="width: 21%">
			...
			<div class="caixa-padrao" style="width: 20%">
				...
				<s:textfield disabled="true" name="motorista.telefoneCelular" />
				<br>
			</div>
			...
			<div class="caixa-padrao" style="width: 15%; float: none">
				...
				<s:textfield type="date" disabled="true"
					name="motorista.dataDeContratacao" />
				<br>
			</div>
		</form>
	</div>
