<div id="global">
	<div class="conteudo">
		...
		<form action="ConfirmarCompra" style="width: 90%" method="post">
			<ul>
				<li>Valor da Passagem: <b><s:label name="passagem.preco"></s:label></b></li>
			...
			<s:hidden name="cliente.cpf" value="#session.usuario.cpf"></s:hidden>
			<s:hidden name="passagem.id" value="passagem.id"></s:hidden>		
			<div align="center">
